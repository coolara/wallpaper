	...
	<view>
		<view class="" v-show="!loadShow">
			...
			<view class="users u-flex u-row-between u-col-center u-p-r-40">
				<view class="user u-p-l-40 u-p-r-40 u-flex u-row-left u-col-center" @click="loginClick">
					...
					<view class="u-p-l-20">
						...
						<view class="addr u-light-color u-p-t-10 u-font-12">换个心情吧~</view>
					</view>
				</view>
			...
			<!-- <view class="menu u-m-l-40 u-m-r-40 u-m-t-40 border-box">
				<view class="u-flex u-row-between u-p-30 border-bottom" hover-class="hover-class1" hover-stay-time="50" @click="gonggaoClick">
					<view class="u-flex u-row-left">
						<image src="/static/icon/xiaoxi.png"></image>
						<view class="u-p-l-20">平台通知</view>
					</view>
			...
			<view class="menu u-m-l-40 u-m-r-40 u-m-t-40 border-box">
				...
				<view class="u-flex u-row-between u-p-30" hover-class="hover-class1" hover-stay-time="50" @click="taskClick">
					<view class="u-flex u-row-left">
			...
			<view class="menu u-m-l-40 u-m-r-40 u-m-t-40 border-box">
				...
				<view class="u-flex u-row-between u-p-30" hover-class="hover-class1" hover-stay-time="50" @click="writeClick" v-if="writeShow">
					<view class="u-flex u-row-left">
...
.div1{height: 40rpx;width: 100%;background: #ffffff;border-radius: 30px 30px 0px 0px;position: absolute;bottom: 0px;}
.div2{height: 40rpx;width: 92%;background: #ffffffb0;border-radius: 10px 10px 0px 0px;position:absolute;bottom: 5px;left: 4%;right: 6%;}
.div3{height: 40rpx;width: 88%;background: #ffffff59;border-radius: 10px 10px 0px 0px;position:absolute;bottom: 10px;left: 6%;right: 8%;}	
	}
