<template>
	<view>
		...
		<view class="top u-flex-col u-col-center u-p-t-80">
			...
			<view class="name u-p-t-30 u-font-18">天天换壁纸吧nft</view>
			<view class="u-tips-color u-font-14 u-p-t-15">换个心情吧</view>
		</view>
		<view class="menu u-m-l-40 u-m-r-40 u-m-t-40 border-box">
			...
			<ad unit-id="adunit-8f852f6b8fb762d7" ad-type="video" ad-theme="white"></ad>
		</view>
		<view class="bottom u-p-40 u-text-center u-font-12 u-tips-color">
			免责声明：本站内容来自用户投稿，如涉及版权问题，请随时联系告知我们。
		</view>
	</view>
</template>
