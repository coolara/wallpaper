	...
	<view class="content">
		<view class="" v-show="!loadShow">
			<view class="vtop">
				...
				<view v-else>
					<scroll-view scroll-x style="height: 100rpx;" :scroll-into-view="rolldistance" :scroll-with-animation="true">
			...
			<view class="u-p-l-25 u-p-r-25 u-p-t-25">
				<image src="https://vkceyugu.cdn.bspapp.com/VKCEYUGU-676f0968-fd33-480e-a7e7-40d1564c0de0/1fa52e45-abfa-4fe2-9291-efc2e3e9e7c1.png" style="width:700rpx;height: 343rpx" @click="txsignClick"></image>
